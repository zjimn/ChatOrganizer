...
class ScrollableFrame(ttk.Frame):
    def __init__(self, container, *args, **kwargs):
        ...
        self.canvas = tk.Canvas(self, highlightthickness=0)  # Disable focus border on the canvas
    ...
    def on_mouse_wheel(self, event):
        # Scroll the canvas up or down based on the wheel movement
    ...
    def adjust_canvas_width(self):
        self.update_idletasks()  # Ensure all pending layout tasks are completed
        if self.scrollbar_visible:
    ...
    def destroy(self):
        self.container.unbind("<MouseWheel>")  # Unbind the mouse wheel event

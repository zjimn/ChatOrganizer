...
class MainWindow:
    ...
    def create_ui(self):
        ...
        self.option_menu.pack(side=tk.RIGHT, padx=5, pady=(0, 0), anchor=tk.S)
        ...
        self.size_menu.pack(side=tk.RIGHT, padx=5, pady=(0, 0), anchor=tk.S)
        ...
        self.output_window_canvas.pack(side=tk.LEFT, fill=tk.Y, expand=True)
        ...
        self.output_window_scrollbar_frame.bind("<Configure>", lambda e: self.output_window_canvas.configure(scrollregion=self.output_window_canvas.bbox("all")))
        ...
        self.tree = ttk.Treeview(self.tree_frame, columns=("#0","id", "img", "prompt", "content", "create_time", "operation"), height=7)

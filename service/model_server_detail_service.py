...
class ModelServerDetailService:
    ...
    def update_or_insert_data(self, server_key: str, txt_model_id: str = None, img_model_id: str = None, api_key: str = None, api_url: str = None):
        with ModelServerDetailAccess() as msda:
            msda.upsert(server_key, txt_model_id, img_model_id, api_key, api_url)
